"""
Cross-dataset replication of grammar rules: do GSI patterns hold across MPRA
datasets measuring the same biology? Human datasets (agarwal, klein, inoue)
should look alike; human vs yeast vs plant should not.

seq_ids do not overlap between datasets, so everything here is distributional:
GSI binned by n_motifs / motif_density, KS and Mann-Whitney comparisons,
GSI~motif_feature regression slopes, and Cohen's d for within- vs cross-species
pairs.
"""
...
print("\n" + "=" * 70)
print("GSI distribution comparison (KS and Mann-Whitney U)")
print("=" * 70)
...
print("\n" + "=" * 70)
print("motif-conditioned GSI patterns (rank-based)")
print("=" * 70)
...
for model in MODELS:
    ...
    # shared n_motifs bins across datasets
    all_n_motifs = pd.concat([data[(ds, model)]["n_motifs"] for ds in DATASETS])
    # quantile bins so bin sizes stay comparable
...
print("\n" + "=" * 70)
print("GSI ~ motif density regression slope comparison")
print("=" * 70)
...
print("\n" + "=" * 70)
print("motif-density-binned GSI profile correlation")
print("=" * 70)
...
print("\n" + "=" * 70)
print("cross-species control: GSI distribution by species")
print("=" * 70)
...
print("\n" + "=" * 70)
print("cohen's d effect sizes: within-species vs cross-species")
print("=" * 70)
...
for model in MODELS:
    ...
    for ds1, ds2 in combinations(DATASETS, 2):
        ...
        # log-transform makes the effect sizes more meaningful
    ...
    print(f"\n    mean |d| within-species = {mean_within:.4f}, "
...
print("\n" + "=" * 70)
print("GSI percentile rank profile by n_motifs")
print("=" * 70)
...
# permutation test: is within-species mean |d| smaller than cross-species?
